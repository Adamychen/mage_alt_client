...
* [ ] **1.2 Match Settings & Permissions**:
...
### B. Search & Filters
* [ ] **2.1 Real-Time Search**: Filter by table name, host/creator, or format.
* [ ] **2.2 Status Filters**:
  * *"Open seats only"* (Waiting).
  * *"Hide in-progress"* (Hide dueling).
  * *"No password only"*.
* [ ] **2.3 Format & Skill Filters**: Quick chips by game format and skill level.

### C. Community & Players Panel (`RoomUsersView`)
* [ ] **3.1 Enriched User List**:
...
* [ ] **4.1 Timing & Rules Configuration**:
  * Per-player clock selection (20m, 25m, 30m, 45m, etc.) and buffer reserve timer.
...
* [ ] **4.2 Multiplayer & Seat Configuration**:
  * Individual AI archetype and deck assignment for each bot seat.
...
|---|---|---|---|
| **1** | **Enriched Table Cards** | Skill Level badges, Lock icon, Relative time, Rated badge, SP/RB permissions, and informative tooltips | 🚀 In progress |
| **2** | **Search & Quick Filters** | Live text search bar and open-seats / no-password toggles | ⬜ Pending |
| **3** | **Community with ELO, Ping & Flags** | Complete user list with ELO ratings, latency, quit ratio, and live activity | ⬜ Pending |
| **4** | **Advanced Table Creation Modal** | Turn clocks, password, skill level, spectator toggles, and individual seat setup | ⬜ Pending |
